    ...
    <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="pb-5">
                                <div class="img w-100">
                                    <a href="">
                                        <img :src="post.image" class="img-rounded rounded w-100 img-post" alt="">
                                    </a>
                                    <span class="blog-post-date">Monday, December 15, 2018</span>
                                </div>
                                <div class="blog-content">
                                    <div class="blog-header pt-3 pb-3">
                                        <span class="me-2"><i class="ri-user-fill me-2"></i><strong>By</strong>
                                            SonDoIt</span>
                                        <span>||</span>
                                        <span class="me-2"><i class="ri-message-2-fill"></i> Comments <span>(3)</span>
                                        </span>
                                    </div>
                                    <div class="blog-body">
                            ...
                            <div class="card mb-3v border-0" v-for="(cmt,index) in comments" :key="index">
                                <div class="row g-0">
                                    <div class="col-md-2">
                                        <img src="../assets/imgs/user/avatar2.jpg"
                                            class="img-thumbnail rounded-start w-100" alt="...">
                                    </div>
                                    <div class="col-md-10">
                                        <div class="card-body">
                                            <h5 class="card-title">{{ cmt.username }}</h5>
                                            <p class="card-text"><small class="text-muted">{{ cmt.date }}</small></p>
                            ...
                            <form @submit.prevent="userComment">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            placeholder="Your Name" v-model="user.username">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3">
                                    <textarea class="form-control" id="message" rows="3" placeholder="Please type what you want..." v-model="commentText"></textarea>
                                </div>
